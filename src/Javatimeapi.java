...
The package java.time was added with the release of Java 8 with the aim of solving problems faced by
Java developers while handling date and time with java.util package such as representing a date without time, etc.
...
==>withYear(int Year) : This method returns a copy of the LocaleDate but alters the year with the value of year
passed as argument.
...
==>LocalTime plusHours(long hoursToAdd) : This method returns a copy of the LocalTime but with the specified
...
==>LocalTime minusMinutes(long minutesToSubtract) : This method returns a copy of the LocalTime but with the
specified number of minutes subtracted.
