     /* LinkedList in Java: Demo & Methods:
       ...
       ==> The insertion & deletion can be done in constant time in Linked List, so it is best to use the linked list
        when you need to add or remove elements frequently.
        ==>Use ArrayList when you want to access the random elements frequently, as it can’t be done in a linked
...
public class CWH extends Thread{
    public static void main(String[] args) {
     ...
     public class Javalinkedlistandmethods {
         public static void main(String[] args) {
             LinkedList<Integer> l1 = new LinkedList<>();
