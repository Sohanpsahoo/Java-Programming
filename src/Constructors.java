class MyMainEmployee{
    ...
    public MyMainEmployee(){
        id = 0;
        name = "Your-Name-Here";    //It is a constructor so it is automatically get invoked , no need to call it.
    }
...
public class Constructors {
    public static void main(String[] args) {
        //MyMainEmployee harry = new MyMainEmployee("SOHAN", 12);
...
4.If we do not create a constructor by ourself, then the default constructor(created by Java compiler) is called.
