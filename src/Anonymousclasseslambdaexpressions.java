...
Dog barks!
 ...
 ==>The same output can be generated without creating the Dog class. This is the scenario where the Anonymous class comes
  into the picture. With the help of the Anonymous class, we can declare and instantiate a class at the same time.
...
==>In the above code, we've created the Bruno object by referencing the Animal interface. So, that's how we
 have overridden the bark() method without creating any separate class.
...
public class Anonymousclasseslambdaexpressions {
    public static void main(String[] args) {
