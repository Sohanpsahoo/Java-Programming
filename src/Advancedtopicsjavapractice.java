...
Answer 1: As we discussed in the ArrayList tutorial of this playlist, add() method is used to insert element
in an ArrayList. Below is the required program :                  */
/*
import java.util.ArrayList;
public class Advancedtopicsjavapractice {
...
Answer 3: In the Calendar class tutorial, we saw how we can use the Calendar.getInstance() static method to initialize
an object of the Calendar class. After creating object, use the get() method to print the date in the desired formate.
...
Answer 4: In the DateTimeFormatter class tutorial, I told you to use the format() method in order to change the date
 and time in the desired format.                                                 */
...
/*       Question 5: Create a Set in java. Try to store the duplicate values elements inside this set and verify
