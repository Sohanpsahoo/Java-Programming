     /*    ArrayDeque in Java:
        ...
        ==>There are no capacity restrictions for ArrayDeque, and it provides us the facility to add or remove
        any element from both sides of the queue.
       ...
       1. ArrayDeque(): Used to create an empty array deque that has the capacity to hold 16 elements.
        2.ArrayDeque(int numElements): Used to create an empty array deque that has the capacity to hold the specified
        number of elements.
        3.ArrayDeque(Collection<? extends E> c): Used to create an array deque containing all the elements of
...
public class CWH extends Thread{
    public static void main(String[] args) {
       ...
       2. Accessing an element :
        ...
        ==>Accessing an element from the head of the deque array: getFirst() & peekFirst() methods are used to
        get the first element of the deque array.
...
public class CWH extends Thread{
    public static void main(String[] args) {
       ...
       Output :
        ...
        ==>Removing the first element: removeFirst() & pollFirst() methods are used to delete an element from the
        head of the queue.
