...
/*    Generating our own JavaDocs for our Package:
 ...
 A reliable documentation is a must for a developer. Just imagine how difficult it would be to write code in a
 language you are not familiar with, without proper documentation. Documentation helps us to develop, maintain and
  transfer knowledge to other developers. As you are already aware that there is a proper documentation available for Java.
   But have you ever thought of creating your own documentation? In this tutorial, I will tell you how you can automatically
   generate documentation for your Java packages with the help of JavaDoc.
