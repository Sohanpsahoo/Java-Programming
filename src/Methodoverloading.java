public class Methodoverloading {
    ...
    public static void main(String[] args) {
        ...
        // change2(marks);                                // HE THE VALUE WILL GET CHANGED AS THE REFERENCE IS PASSED TO THE CALLING METHOD
...
/*
 ...
 1.In Java, it is possible for a class to contain two or more methods with the same name but with different parameters.
  Such methods are called Overloaded methods.
 2.Method overloading is used to increase the readability of the program.
...
A. By changing the return type :
    1.In the below example, we've created a class named calculate.
    2.In the calculate class, we've two methods with the same name i.e. multiply
    3.These two methods are overloaded because they have the same name but their return is different.
    4.The return type of 1st method is int while the return type of the other method is double.
...
1.Again, we've created two methods with the same name i.e., multiply
2.The return type of both the methods is int.
3.But, the first method 2 arguments and the other method accepts 3 arguments.
