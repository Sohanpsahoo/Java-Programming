...
public class Getterssettersaccessmodifiers {
...
So, is there any way by which we can access the private access modifiers outside the class?
The answer is Yes! We can access the private access modifiers outside the class with the help of getters and setters.

Getters and Setters :
1.Getter ➼   Returns the value  [accessors]
2.setter ➼    Sets / updates the value  [mutators]
...
Shubham
1
As you can see that we've got our expected output. So, that's how we use the getters and setters method to get and
 set the values of private access modifiers outside the class.
