/*   The Date Class in Java:
      ...
      Answer: Yes, it is absolutely safe to store the number of milliseconds in a variable of type long
      because the maximum value that can be stored in long is 9223372036854775807. You can see that the maximum
      value of long is huge. Therefore, we do not need to worry about the value of milliseconds. Notice the output
      of the below code; the value of current time in millisecond is 10^6 times smaller than the maximum value of long data type.
...
public class CWH extends Thread{
    public static void main(String[] args) {
       ...
       ==> Date(): This constructor is used when we need an object of current date and time.
        ==>Date(long milliseconds): This constructor creates a date object from the number of milliseconds passed
...
public class CWH extends Thread{
    public static void main(String[] args) {
        ...
        The date calculated form milliseconds is : Sun May 23 00:23:59 IST 2021
